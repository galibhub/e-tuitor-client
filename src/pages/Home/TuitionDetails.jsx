        ...
        <div className="bg-base-100 rounded-2xl shadow-lg border border-base-200 p-8 mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <div className="flex flex-wrap items-center gap-3 mb-3">
               <span className="badge badge-primary badge-outline font-semibold">{tuition.subject}</span>
               <span className="badge badge-secondary badge-outline font-semibold">{tuition.classLevel}</span>
               <span className="badge badge-ghost text-xs uppercase tracking-wide">{tuition.tuitionType}</span>
            </div>
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="bg-base-100 p-5 rounded-2xl border border-base-200 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div>
                            <p className="text-sm text-base-content/60 font-medium">Monthly Salary</p>
                    ...
                    <div className="bg-base-100 p-5 rounded-2xl border border-base-200 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div>
                            <p className="text-sm text-base-content/60 font-medium">Schedule</p>
                    ...
                    <div className="bg-base-100 p-5 rounded-2xl border border-base-200 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div>
                            <p className="text-sm text-base-content/60 font-medium">Medium</p>
                    ...
                    <div className="bg-base-100 p-5 rounded-2xl border border-base-200 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div>
                            <p className="text-sm text-base-content/60 font-medium">Type</p>
                            <p className="text-lg font-bold text-base-content capitalize">{tuition.tuitionType}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-base-100 rounded-2xl shadow-sm border border-base-200 p-8">
                   <h3 className="text-xl font-bold mb-4 border-b border-base-200 pb-2">Description / Requirements</h3>
               ...
               <div className="bg-base-100 rounded-2xl shadow-sm border border-base-200 p-6 sticky top-10">
                      ...
                      <div className="avatar placeholder">
                        <div className="bg-neutral text-neutral-content rounded-full w-16 shadow-inner ring ring-base-200 ring-offset-2">
                             {tuition.studentPhoto ? (
                                ...
                                <span className="text-xl font-bold uppercase">{tuition.studentName?.charAt(0)}</span>
                             )}
                        </div>
                      </div>
                      <div className="overflow-hidden">
                          <p className="font-bold text-lg leading-none truncate">{tuition.studentName}</p>
                          <p className="text-sm text-base-content/60 mt-1">Student / Guardian</p>
                      </div>
                  </div>
                  ...
                  <div className="space-y-3">
                     ...
                     <div className="flex items-center gap-3 text-sm p-3 bg-base-200/50 rounded-lg border border-base-200">
                        ...
                        <span className="font-medium truncate">{tuition.location}</span>
                     </div>
                  </div>
